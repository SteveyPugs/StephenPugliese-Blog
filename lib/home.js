...
internals.GetEntry = function() {
	...
	var session = request.auth.credentials;
		...
		//{
			if (session)
			{post = {entries:results[0],userid:session.adminid,userstatus:true,archiveresults:results[1],tags:results[2],comments:results[3],newcomment:true};}
			else
			{post = {entries:results[0],userstatus:false,archiveresults:results[1],tags:results[2],comments:results[3],newcomment:true};}
